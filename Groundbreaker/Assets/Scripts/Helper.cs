...
public static class Helper {
	...
	public enum ServerRequestType{		// required Inputs		Return Values

		SendPosition,					// PlayerLocation		"ACK"
		RecievePositions,				// Vector2				List<Player>
		RecieveCircle,					// Vector2				CircleOfAction
		NewPlayer,						// LoginCredentials		Player / null
		LogIn,							// LoginCredentials		Player / null
		UpdatePlayer,					// Player				"ACK"
		AttackPoint,					// PointAttack			CircleOfAction
		CreatePoint,					// NewPointAttack		CircleOfAction
		SupportPoint					// PointAttack			CircleOfAction
	}
